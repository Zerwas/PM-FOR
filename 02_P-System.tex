...
\end{lemma}
\begin{proof}
	The $\Leftarrow$ direction is proven in Claim \ref{cla.17}. And the $\Rightarrow$ direction is a direct consequence of Claim \ref{cla.18} with $C=\langle Q_0,0,0\rangle$.
\end{proof}
