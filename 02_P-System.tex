...
\begin{definition}
Let $\Gamma$ be a basis. The \SysP-formula $A$ is a \define{sematic consequence with falsity} of $\Gamma$, denoted by $\Gamma\PModelsf A$, if for every interpretation $I$
