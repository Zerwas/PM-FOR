...
child [sibling distance=3cm] {node(1) {\vdashf P(d,a_0)} 
	child {node(11) {\vdashf P_1(b,d)} }
	child [sibling distance=3.7cm] {node(12) {\vdashf P_1(b,d)\to Q'(b)} 
		child {node(121) {\vdashf P_1(a,a_0)} }
		child [sibling distance=4.5cm] {node(122) {\vdashf P_1(a,a_0)\to P_1(b,d)\to Q'(b)} 
			child {node(1221) {\vdashf S(a,b)} }
			child [sibling distance=5cm] {node(1222) {\vdashf S(a,b)\to P_1(a,a_0)\to P_1(b,d)\to Q'(b)}
				child {node(12221) {\vdashf Q(a)} }
				child {node(12222) {\vdashf Q(a)\to S(a,b)\to P_1(a,a_0)\to P_1(b,d)\to Q'(b)}
					child {node(122221) {\vdashf \forall\alpha\beta\gamma\delta(Q(\alpha)\to S(\alpha,\beta)\to P_1(\alpha,\gamma)\to P_1(\beta,\delta)\to P(\delta,\gamma))}}}
				child {}}
			child {}}
		child {}}
	child {}}
