...
%TODO meintion the convention that a free and \alpha not or change the convention :D
...
\end{proof}
\begin{definition}
The problem to decide whether a given set of \SysP-formulas is consistency, denoted by \PCons, is defined as follows.
...
We will show that $\autHalt\leq\PCons$ then the undecidability of \PCons{} directly follows from the undecidability of \autHalt.
$\Gamma_C:$
\begin{itemize}
\item $Q(a)$
