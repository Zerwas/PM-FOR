...
\def\dist{0.4cm}
\node(e) {\vdashf \falses} [sibling distance=2*\dist+5cm] 
	child {node(1) {\vdashf R_2(b,b_0)} [sibling distance=\dist+3.3cm]
		child[xshift=2cm] {node(11) {\vdashf R_2(a,b_0)}}
		child[xshift=2cm] {node(12) {\vdashf R_2(a,b_0)\to R_2(b,b_0)} [sibling distance=\dist+4cm]
			child[xshift=2cm] {node(121) {\vdashf S(a,b)}}
			child[xshift=2cm] {node(122) {\vdashf S(a,b)\to R_2(a,b_0)\to R_2(b,b_0)} [sibling distance=\dist+4.4cm]
