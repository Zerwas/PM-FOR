...
\node(e) {\vdashf \falses} [sibling distance=6.4cm] 
	child {node(1) {\vdashf R_1(b,a_0)} [sibling distance=3.2cm]
		child[xshift=1.7cm] {node(11) {\vdashf E(a_0)}}
		child[xshift=1.7cm] {node(12) {\vdashf E(a_0)\to R_1(b,a_0)} [sibling distance=4.5cm]
			child[xshift=2cm] {node(121) {\vdashf R_1(a,a_0)}}
			child[xshift=2cm] {node(122) {\vdashf R_1(a,a_0)\to E(a_0)\to R_1(b,a_0)} [sibling distance=5.2cm]
				child[xshift=2cm] {node(1221) {\vdashf S(a,b)}}
				child[xshift=2cm] {node(1222) {\vdashf S(a,b)\to R_1(a,a_0)\to E(a_0)\to R_1(b,a_0)} [sibling distance=5.9cm]
					child[xshift=2cm] {node(12221) {\vdashf Q(a)}}
					child[xshift=2cm] {node(12222) {\vdashf Q(a)\to S(a,b)\to R_1(a,a_0)\to E(a_0)\to R_1(b,a_0)}
						child {node(122221) {\vdashf\forall\alpha\beta\gamma(Q(\alpha)\to S(\alpha,\beta)\to R_1(\alpha,\gamma)\to E(\gamma)\to R_1(\beta,\gamma))}}}}}}}
	child {node(2) {\vdashf R_1(b,a_0)\to\falses}
		child {node(21) {R_1(b,a_0)\vdashf\falses}
