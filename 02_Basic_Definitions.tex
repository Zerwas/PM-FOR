...
\begin{definition}
	...
	\end{align*}
\end{definition}
\begin{definition} Let $\mathcal{V}$ be a finite subset of \lambdaTypVar{}.	A \define{basis} $\Gamma=\{(x_1:t_1),(x_2,t_2),\dots,(x_n,t_n)\}$ is a mapping from $\mathcal{V}$ to \lambdaTypes{}.
