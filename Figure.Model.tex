...
\path (1) edge[bend right=60] node[above,label] {P_1} (0);
\path (1) edge[bend left=60] node[below,label] {P_2} (0);

\path (7) edge[bend right=50] node[above,label] {P_1} (3);
\path (7) edge[bend left=60] node[below,label] {P_2} (5);
