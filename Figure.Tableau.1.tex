...
\node(e) {\PModelsf \falses} [sibling distance=8cm] 
	...
	child {node(2) {\PModelsf(\forall\beta(S(a,\beta)\to\falses)\to\falses)\to\falses}
		child {node(21) {\forall\beta(S(a,\beta)\to\falses)\to\falses\PModelsf\falses}
			child[xshift=1cm,sibling distance=8.8cm] {node(211) {S(a,b)\PModelsf\falses}
				child[xshift=1cm,sibling distance=3.6cm] {node(2111) {S(a,b)\PModelsf D(b)}
					child {node(21111) {S(a,b)\PModelsf S(a,b)}}
					child {node(21112) {S(a,b)\PModelsf S(a,b)\to D(b)}
						child {node(211121) {S(a,b)\PModelsf \forall\alpha\beta(S(\alpha,\beta)\to D(\beta))}}}}
				child[xshift=0.7cm] {node(2112) {S(a,b)\PModelsf D(b)\to\falses}
					child {node(21121) {S(a,b), D(b)\PModelsf\falses}
