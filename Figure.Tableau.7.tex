...
\node(e) {\vdashf \falses} [sibling distance=5cm] 
	child {node(1) {\vdashf Q_2(b)} [sibling distance=2.7cm]
		child[xshift=1.7cm] {node(11) {\vdashf E(a_0)}}
		child[xshift=1.7cm] {node(12) {\vdashf E(a_0)\to Q_2(b)} [sibling distance=3.8cm]
			child[xshift=2cm] {node(121) {\vdashf R_1(a,a_0)}}
			child[xshift=2cm] {node(122) {\vdashf R_1(a,a_0)\to E(a_0)\to Q_2(b)} [sibling distance=4.3cm]
				child[xshift=2cm] {node(1221) {\vdashf S(a,b)}}
				child[xshift=2cm] {node(1222) {\vdashf S(a,b)\to R_1(a,a_0)\to E(a_0)\to Q_2(b)} [sibling distance=4.8cm]
