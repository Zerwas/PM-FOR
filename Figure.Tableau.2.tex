...
\node(e) {\PModelsf\falses} [sibling distance=8.5cm]
	child {node(1) {\PModelsf\forall\beta(R_1(b,\beta)\to\falses)\to\falses} [sibling distance=4cm]
		child {node(11) {\PModelsf G(a)}}
		child {node(12) {\PModelsf G(a)\to\forall\beta(R_1(b,\beta)\to\falses)\to\falses}
			child {node(121) {\PModelsf\forall\alpha(G(\alpha)\to\forall\beta(R_1(\alpha,\beta)\to\falses)\to\falses)}}}}
